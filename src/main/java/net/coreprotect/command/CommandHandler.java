        ...
        if (commandName.equals("core") || commandName.equals("coreprotect") || commandName.equals("co")) {
            ...
            if (resultc > -1) {
                ...
                if (!permission) {
                    ...
                    else if (user.hasPermission("coreprotect.purge") && corecommand.equals("migrate")) {
                        permission = true;
                    }
                }
                ...
                else if (corecommand.equals("migrate")) {
                    MigrateCommand.runCommand(user, permission, argumentArray);
                }
